...
parser.add_argument('--data_root', type=str, default="SIIM-FISABIO-RSNA-COVID-19-Detection")
parser.add_argument('--dcm_folds_train', type=str, default="/dcm_folds/data_train_dcm_fold0.pickle")
parser.add_argument('--dcm_folds_val', type=str, default="/dcm_folds/data_val_dcm_fold0.pickle")
